...
def smooth_xsec(wavenumber, xsec, alpha=1000):
    ...
    smoothed = gaussian_filter1d(xsec, rang) #Performs gaussian smoothing
...
def optimize_alpha(alpha_range, wavenumber, xsec,style = "iterate",num_turning_points=1, **kwargs):
    if "i" in style.lower():
        data = []
